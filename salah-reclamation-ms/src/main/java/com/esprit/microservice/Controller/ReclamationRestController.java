...
public class ReclamationRestController {
	...
	ReclamationService ReclamationService;
	 // http://localhost:8035/reclamation/reclamations
	 @GetMapping("/reclamations")
	 public List<Reclamation> getReclamations() {
	 List<Reclamation> listReclamations =ReclamationService.retrieveAllReclamations();
	 return listReclamations;
	 }
	// http://localhost:8035/reclamation/retrieve-reclamation/8
		...
		// http://localhost:8035/reclamation/delete/{reclamation-id}
		...
		// http://localhost:8035/reclamation/retrieve-by-titre/{titre}
